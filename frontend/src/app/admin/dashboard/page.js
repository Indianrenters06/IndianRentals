...
export default function AdminDashboard() {
    ...
    const LeadProgressBar = ({ stage, count, percentage }) => (
        <div className="mb-4">
            ...
            <Progress size="sm" value={percentage} classNames={{ indicator: "bg-gray-900" }} aria-label={stage} />
        </div>
    );
                ...
                <div className="px-8 py-6">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <Button color="primary" startContent={<FiDownload className="w-4 h-4" />} className="font-medium">
                                Download
                            </Button>
                        </div>
                    </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="lg:col-span-2 bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                        <div className="flex items-center justify-between mb-6">
                            ...
                            <div className="flex items-center gap-3">
                                <Button variant="flat" startContent={<FiFilter className="w-4 h-4" />} size="sm">
                                    Filter Projects...
                                </Button>
                                    ...
                                    {stats.recentRentals?.slice(0, 5).map((rental, index) => (
                                        <tr key={index} className="hover:bg-gray-50 transition-colors">
                                            <td className="py-4 px-4">
                                                <Checkbox aria-label={`Select ${rental.user?.name || 'Customer'}`} />
                                            </td>
                                            <td className="py-4 px-4">
                        ...
                        <div className="space-y-4">
                            <div className="p-4 bg-gray-50 rounded-lg">
                                <div className="flex items-center justify-between mb-2">
                                    ...
                                    <Switch defaultSelected color="primary" aria-label="Strictly Necessary" />
                                </div>
                            ...
                            <div className="p-4 bg-gray-50 rounded-lg">
                                <div className="flex items-center justify-between mb-2">
                                    ...
                                    <Switch defaultSelected color="primary" aria-label="Functional Cookies" />
                                </div>
                            ...
                            <div className="p-4 bg-gray-50 rounded-lg">
                                <div className="flex items-center justify-between mb-2">
                                    ...
                                    <Switch defaultSelected color="primary" aria-label="Performance Cookies" />
                                </div>

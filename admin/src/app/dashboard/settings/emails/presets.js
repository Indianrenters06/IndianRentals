    ...
    <table role="presentation" class="email-container" cellspacing="0" cellpadding="0" border="0" width="600" style="max-width: 600px; width: 100%;">
      ...
      <tr>
        <td bgcolor="#ffffff" style="background-color: #ffffff; border-radius: 12px 12px 0 0; padding: 24px 32px; border-bottom: 3px solid #ffcf46;" align="center">
          <a href="https://indian-rentals.vercel.app" style="text-decoration: none; display: inline-block;">
            <img src="https://res.cloudinary.com/dgkckcdk8/image/upload/w_360,q_auto,f_png/v1780249866/logo_indianrenters_tmfo74.png" alt="IndianRenters.com" width="180" height="auto" style="display: block; width: 180px; max-width: 180px; height: auto; border: 0;" />
          </a>
        </td>
      </tr>
              ...
              <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center">
                <tr>
                  <td bgcolor="#ffcf46" style="background-color: #ffcf46; border-radius: 8px;" align="center">
                    <a href="https://indian-rentals.vercel.app/products" style="display: inline-block; padding: 14px 36px; font-family: 'Mona Sans Variable', sans-serif; font-size: 15px; font-weight: 600; color: #000000; text-decoration: none; letter-spacing: -0.4px; border-radius: 8px;">Browse Products &nbsp;→</a>
                  </td>
                </tr>
              </table>
              <p style="margin: 16px 0 0 0; font-family: 'Mona Sans Variable', sans-serif; font-size: 13px; color: #757575; text-align: center;">or <a href="https://indian-rentals.vercel.app/how-it-works" style="color: #0075ff; text-decoration: none; font-weight: 500;">See how renting works →</a></p>
            </td></tr>
          </table>
        </td>
      </tr>
      ...
      <tr>
        <td bgcolor="#141414" style="background-color: #141414; border-radius: 0 0 12px 12px; padding: 32px 32px 28px 32px;">
          <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
            <tr><td align="center" style="padding-bottom: 20px;"><a href="https://indian-rentals.vercel.app" style="text-decoration: none;"><img src="https://res.cloudinary.com/dgkckcdk8/image/upload/w_280,q_auto,f_png/v1780249784/white_indianrenters_nnqhiu.png" alt="IndianRenters.com" width="140" height="auto" style="display: block; width: 140px; height: auto; border: 0;" /></a></td></tr>
            ...
            <tr><td align="center" style="padding-bottom: 16px;">
              <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center">
                <tr>
                  ...
                  <td style="padding: 0 12px; border-left: 1px solid #2a2a2a;"><a href="https://indian-rentals.vercel.app" style="font-family: 'Mona Sans Variable', sans-serif; font-size: 12px; color: #757575; text-decoration: none;">indianrenters.com</a></td>
                </tr>
              </table>
            </td></tr>
            ...
            <tr><td align="center">
              ...
              <p style="margin: 0; font-family: 'Mona Sans Variable', sans-serif; font-size: 11px; color: #545454; text-align: center;">You received this because you created an account on IndianRenters.com.&nbsp;<a href="https://indian-rentals.vercel.app/unsubscribe?email={{email}}" style="color: #757575; text-decoration: underline;">Unsubscribe</a>&nbsp;·&nbsp;<a href="https://indian-rentals.vercel.app/privacy" style="color: #757575; text-decoration: underline;">Privacy Policy</a></p>
            </td></tr>
          </table>
        </td>
      </tr>
        ...
        <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="600" style="max-width: 600px; width: 100%;">
          ...
          <tr>
            <td bgcolor="#ffffff" align="center" style="background-color: #ffffff; border-radius: 12px 12px 0 0; padding: 24px 40px; border-bottom: 3px solid #ffcf46;">
              <a href="https://indian-rentals.vercel.app" style="text-decoration: none; display: inline-block;">
                <img src="https://res.cloudinary.com/dgkckcdk8/image/upload/w_360,q_auto,f_png/v1780249866/logo_indianrenters_tmfo74.png" alt="IndianRenters.com — You Name It, We Rent It" width="180" height="auto" style="display: block; width: 180px; max-width: 180px; height: auto; border: 0;" />
              </a>
            </td>
          </tr>
          ...
          <tr>
            <td bgcolor="#141414" align="center" style="background-color: #141414; border-radius: 0 0 12px 12px; padding: 28px 40px;">
              <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr><td align="center" style="padding-bottom: 12px;"><a href="https://indian-rentals.vercel.app" style="text-decoration: none;"><img src="https://res.cloudinary.com/dgkckcdk8/image/upload/w_280,q_auto,f_png/v1780249784/white_indianrenters_nnqhiu.png" alt="IndianRenters.com" width="140" height="auto" style="display: block; width: 140px; max-width: 140px; height: auto; border: 0;" /></a></td></tr>
                  ...
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                      <td style="vertical-align: middle;">
                        <a href="https://indian-rentals.vercel.app" style="text-decoration: none; display: inline-block;">
                          <img src="https://res.cloudinary.com/dgkckcdk8/image/upload/w_360,q_auto,f_png/v1780249866/logo_indianrenters_tmfo74.png" alt="IndianRenters.com" width="160" height="auto" style="display: block; width: 160px; max-width: 160px; height: auto; border: 0;" />
                        </a>
                      </td>
              ...
              <tr>
                <td align="center" style="padding: 32px 32px 36px 32px;">
                  ...
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0" style="margin-bottom: 16px;">
                    <tr><td bgcolor="#ffcf46" style="background-color: #ffcf46; border-radius: 8px;" align="center"><a href="https://indian-rentals.vercel.app/orders/{{ORDER_ID}}" style="display: inline-block; padding: 12px 32px; font-family: 'Mona Sans Variable', sans-serif; font-size: 14px; font-weight: 700; color: #000000; text-decoration: none; border-radius: 8px;">🚚 Track Your Order</a></td></tr>
                  </table>
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                    <tr><td bgcolor="#141414" style="background-color: #141414; border-radius: 8px;" align="center"><a href="https://indian-rentals.vercel.app/orders" style="display: inline-block; padding: 11px 28px; font-family: 'Mona Sans Variable', sans-serif; font-size: 13px; font-weight: 600; color: #ffffff; text-decoration: none; border-radius: 8px;">View All Orders</a></td></tr>
                  </table>
                </td>
              </tr>
            </table>
            ...
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
              <tr>
                <td align="center" style="padding: 28px 32px;">
                  <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
                    <tr><td align="center" style="padding-bottom: 20px;"><a href="https://indian-rentals.vercel.app" style="text-decoration: none;"><img src="https://res.cloudinary.com/dgkckcdk8/image/upload/w_280,q_auto,f_png/v1780249784/white_indianrenters_nnqhiu.png" alt="IndianRenters.com" width="140" height="auto" style="display: block; width: 140px; max-width: 140px; height: auto; border: 0;" /></a></td></tr>
                  </table>
            ...
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
              <tr>
                <td style="padding: 24px 32px 28px 32px;">
                  ...
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-bottom: 14px;"><tr><td bgcolor="#2a2a2a" style="background-color: #2a2a2a; height: 1px; font-size: 0; line-height: 0;">&nbsp;</td></tr></table>
                  <p style="margin: 0 0 10px 0; font-family: 'Mona Sans Variable', sans-serif; font-size: 12px; color: #545454; text-align: center; line-height: 20px;"><a href="https://indian-rentals.vercel.app/privacy-policy" style="color: #757575; text-decoration: underline;">Privacy Policy</a> &nbsp;·&nbsp; <a href="https://indian-rentals.vercel.app/terms" style="color: #757575; text-decoration: underline;">Terms of Service</a> &nbsp;·&nbsp; <a href="https://indian-rentals.vercel.app/unsubscribe" style="color: #757575; text-decoration: underline;">Unsubscribe</a></p>
      ...
      <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="600" class="email-wrapper" style="max-width: 600px; width: 100%;">
        ...
        <tr>
          <td bgcolor="#ffffff" style="background-color: #ffffff; border-radius: 12px 12px 0 0; border-bottom: 3px solid #ffcf46; padding: 20px 32px;" class="mobile-pad">
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
              <tr>
                <td valign="middle"><a href="https://indian-rentals.vercel.app" style="text-decoration: none; display: inline-block;"><img src="https://res.cloudinary.com/dgkckcdk8/image/upload/w_360,q_auto,f_png/v1780249866/logo_indianrenters_tmfo74.png" alt="IndianRenters.com" width="160" height="auto" style="display: block; width: 160px; max-width: 160px; height: auto; border: 0;" /></a></td>
            ...
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" style="background-color: #f6f6f6; border: 1px solid #e2e2e2; border-radius: 12px;">
              ...
              <tr>
                <td style="padding: 16px 20px;">
                  ...
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tr><td style="padding-top: 12px; border-top: 1px dashed #e2e2e2; text-align: center;"><a href="https://indian-rentals.vercel.app/receipts/{{TRANSACTION_ID}}" style="font-family: 'Mona Sans Variable', sans-serif; font-size: 13px; font-weight: 600; color: #0075ff; text-decoration: underline;">⬇ Download Receipt (PDF)</a></td></tr>
                  </table>
                </td>
              </tr>
            </table>
        ...
        <tr>
          <td bgcolor="#141414" style="background-color: #141414; border-radius: 0 0 12px 12px; padding: 28px 32px;" class="mobile-pad">
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
              <tr><td align="center" style="text-align: center; padding-bottom: 16px; border-bottom: 1px solid #1f1f1f;"><a href="https://indian-rentals.vercel.app" style="text-decoration: none;"><img src="https://res.cloudinary.com/dgkckcdk8/image/upload/w_280,q_auto,f_png/v1780249784/white_indianrenters_nnqhiu.png" alt="IndianRenters.com" width="140" height="auto" style="display: block; width: 140px; max-width: 140px; height: auto; border: 0;" /></a></td></tr>
              ...
              <tr><td align="center" style="text-align: center; padding-top: 16px; border-top: 1px solid #1f1f1f;"><div style="font-family: 'Mona Sans Variable', sans-serif; font-size: 11px; color: #545454; line-height: 18px; margin-bottom: 8px;">This email was sent to you because you made a payment on IndianRenters.com.</div><div><a href="https://indian-rentals.vercel.app/privacy" style="font-family: 'Mona Sans Variable', sans-serif; font-size: 11px; color: #545454; text-decoration: underline;">Privacy Policy</a><span style="color: #333333; padding: 0 6px;">·</span><a href="https://indian-rentals.vercel.app/terms" style="font-family: 'Mona Sans Variable', sans-serif; font-size: 11px; color: #545454; text-decoration: underline;">Terms of Service</a><span style="color: #333333; padding: 0 6px;">·</span><a href="https://indian-rentals.vercel.app/unsubscribe" style="font-family: 'Mona Sans Variable', sans-serif; font-size: 11px; color: #545454; text-decoration: underline;">Unsubscribe</a></div><div style="font-family: 'Mona Sans Variable', sans-serif; font-size: 10px; color: #333333; margin-top: 10px;">© 2024 AAA Rental LLP. All rights reserved. · Noida Sector 62, Uttar Pradesh, India</div></td></tr>
            </table>
          </td>
        </tr>
            ...
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
              <tr>
                <td align="center" style="text-align: center;">
                  ...
                  <p style="margin: 0; font-family: 'Mona Sans Variable', sans-serif; font-size: 13px; color: #545454; line-height: 20px;">Or <a href="https://indian-rentals.vercel.app/orders/{{ORDER_ID}}/payment" style="color: #0075ff; font-weight: 600; text-decoration: underline;">try a different payment method</a></p>
                </td>
              </tr>
            </table>
          </td>
        ...
        <tr>
          <td bgcolor="#141414" style="background-color: #141414; border-radius: 0 0 12px 12px; padding: 28px 32px;" class="mobile-pad">
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
              ...
              <tr><td align="center" style="text-align: center; padding-top: 16px; padding-bottom: 16px;"><table role="presentation" border="0" cellpadding="0" cellspacing="0" style="margin: 0 auto;"><tr><td style="padding: 0 12px; border-right: 1px solid #333333;"><a href="mailto:support@indianrenters.com" style="font-family: 'Mona Sans Variable', sans-serif; font-size: 12px; color: #757575; text-decoration: none;">support@indianrenters.com</a></td><td style="padding: 0 12px;"><a href="tel:9870533392" style="font-family: 'Mona Sans Variable', sans-serif; font-size: 12px; color: #757575; text-decoration: none;">+91 98705 33392</a></td></tr></table><div style="margin-top: 6px; font-family: 'Mona Sans Variable', sans-serif; font-size: 11px; color: #545454;">Mon – Sat, 10:00 AM – 7:30 PM</div></td></tr>
              <tr><td align="center" style="text-align: center; padding-bottom: 16px;"><div style="font-family: 'Mona Sans Variable', sans-serif; font-size: 11px; color: #545454; line-height: 18px;">Delhi · Noida · Bangalore · Hyderabad · Mumbai · Pune · Chennai · Kolkata</div></td></tr>
              <tr><td align="center" style="text-align: center; padding-top: 16px; border-top: 1px solid #1f1f1f;"><div style="font-family: 'Mona Sans Variable', sans-serif; font-size: 11px; color: #545454; line-height: 18px; margin-bottom: 8px;">This email was sent because a payment attempt was made on IndianRenters.com.</div><div><a href="https://indian-rentals.vercel.app/privacy" style="font-family: 'Mona Sans Variable', sans-serif; font-size: 11px; color: #545454; text-decoration: underline;">Privacy Policy</a><span style="color: #333333; padding: 0 6px;">·</span><a href="https://indian-rentals.vercel.app/terms" style="font-family: 'Mona Sans Variable', sans-serif; font-size: 11px; color: #545454; text-decoration: underline;">Terms of Service</a><span style="color: #333333; padding: 0 6px;">·</span><a href="https://indian-rentals.vercel.app/unsubscribe" style="font-family: 'Mona Sans Variable', sans-serif; font-size: 11px; color: #545454; text-decoration: underline;">Unsubscribe</a></div><div style="font-family: 'Mona Sans Variable', sans-serif; font-size: 10px; color: #333333; margin-top: 10px;">© 2024 AAA Rental LLP. All rights reserved. · Noida Sector 62, Uttar Pradesh, India</div></td></tr>
            </table>
          </td>
        </tr>
            ...
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
              <tr>
                <td align="center" style="text-align: center;">
                  ...
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0" style="margin: 0 auto 12px auto;"><tr><td align="center" bgcolor="#ffcf46" style="background-color: #ffcf46; border-radius: 8px;"><a href="https://indian-rentals.vercel.app/orders/{{ORDER_ID}}" class="cta-button" style="display: inline-block; padding: 12px 32px; font-family: 'Mona Sans Variable', sans-serif; font-size: 15px; font-weight: 600; color: #000000; text-decoration: none; border-radius: 8px;">📦 Track Your Order →</a></td></tr></table>
                </td>
              </tr>
            </table>
          </td>
        ...
        <tr>
          <td bgcolor="#141414" style="background-color: #141414; border-radius: 0 0 12px 12px; padding: 28px 32px;" class="mobile-pad">
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
              ...
              <tr><td align="center" style="text-align: center; padding-top: 16px; padding-bottom: 16px;"><table role="presentation" border="0" cellpadding="0" cellspacing="0" style="margin: 0 auto;"><tr><td style="padding: 0 12px; border-right: 1px solid #333333;"><a href="mailto:support@indianrenters.com" style="font-family: 'Mona Sans Variable', sans-serif; font-size: 12px; color: #757575; text-decoration: none;">support@indianrenters.com</a></td><td style="padding: 0 12px;"><a href="tel:9870533392" style="font-family: 'Mona Sans Variable', sans-serif; font-size: 12px; color: #757575; text-decoration: none;">+91 98705 33392</a></td></tr></table><div style="margin-top: 6px; font-family: 'Mona Sans Variable', sans-serif; font-size: 11px; color: #545454;">Mon – Sat, 10:00 AM – 7:30 PM</div></td></tr>
              <tr><td align="center" style="text-align: center; padding-bottom: 16px;"><div style="font-family: 'Mona Sans Variable', sans-serif; font-size: 11px; color: #545454; line-height: 18px;">Delhi · Noida · Bangalore · Hyderabad · Mumbai · Pune · Chennai · Kolkata</div></td></tr>
              <tr><td align="center" style="text-align: center; padding-top: 16px; border-top: 1px solid #1f1f1f;"><div style="font-family: 'Mona Sans Variable', sans-serif; font-size: 11px; color: #545454; line-height: 18px; margin-bottom: 8px;">This email was sent to you because your order was approved on IndianRenters.com.</div><div><a href="https://indian-rentals.vercel.app/privacy" style="font-family: 'Mona Sans Variable', sans-serif; font-size: 11px; color: #545454; text-decoration: underline;">Privacy Policy</a><span style="color: #333333; padding: 0 6px;">·</span><a href="https://indian-rentals.vercel.app/terms" style="font-family: 'Mona Sans Variable', sans-serif; font-size: 11px; color: #545454; text-decoration: underline;">Terms of Service</a><span style="color: #333333; padding: 0 6px;">·</span><a href="https://indian-rentals.vercel.app/unsubscribe" style="font-family: 'Mona Sans Variable', sans-serif; font-size: 11px; color: #545454; text-decoration: underline;">Unsubscribe</a></div><div style="font-family: 'Mona Sans Variable', sans-serif; font-size: 10px; color: #333333; margin-top: 10px;">© 2024 AAA Rental LLP. All rights reserved. · Noida Sector 62, Uttar Pradesh, India</div></td></tr>
            </table>
          </td>
        </tr>
        ...
        <tr>
          <td bgcolor="#141414" style="background-color: #141414; border-radius: 0 0 12px 12px; padding: 28px 32px;" class="mobile-pad">
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
              ...
              <tr><td align="center" style="text-align: center; padding-top: 16px; padding-bottom: 16px;"><table role="presentation" border="0" cellpadding="0" cellspacing="0" style="margin: 0 auto;"><tr><td style="padding: 0 12px; border-right: 1px solid #333333;"><a href="mailto:support@indianrenters.com" style="font-family: 'Mona Sans Variable', sans-serif; font-size: 12px; color: #757575; text-decoration: none;">support@indianrenters.com</a></td><td style="padding: 0 12px;"><a href="tel:9870533392" style="font-family: 'Mona Sans Variable', sans-serif; font-size: 12px; color: #757575; text-decoration: none;">+91 98705 33392</a></td></tr></table><div style="margin-top: 6px; font-family: 'Mona Sans Variable', sans-serif; font-size: 11px; color: #545454;">Mon – Sat, 10:00 AM – 7:30 PM</div></td></tr>
              <tr><td align="center" style="text-align: center; padding-bottom: 16px;"><div style="font-family: 'Mona Sans Variable', sans-serif; font-size: 11px; color: #545454; line-height: 18px;">Delhi · Noida · Bangalore · Hyderabad · Mumbai · Pune · Chennai · Kolkata</div></td></tr>
              <tr><td align="center" style="text-align: center; padding-top: 16px; border-top: 1px solid #1f1f1f;"><div style="font-family: 'Mona Sans Variable', sans-serif; font-size: 11px; color: #545454; line-height: 18px; margin-bottom: 8px;">This email was sent to you because your order is out for delivery with IndianRenters.com.</div><div><a href="https://indian-rentals.vercel.app/privacy" style="font-family: 'Mona Sans Variable', sans-serif; font-size: 11px; color: #545454; text-decoration: underline;">Privacy Policy</a><span style="color: #333333; padding: 0 6px;">·</span><a href="https://indian-rentals.vercel.app/terms" style="font-family: 'Mona Sans Variable', sans-serif; font-size: 11px; color: #545454; text-decoration: underline;">Terms of Service</a><span style="color: #333333; padding: 0 6px;">·</span><a href="https://indian-rentals.vercel.app/unsubscribe" style="font-family: 'Mona Sans Variable', sans-serif; font-size: 11px; color: #545454; text-decoration: underline;">Unsubscribe</a></div><div style="font-family: 'Mona Sans Variable', sans-serif; font-size: 10px; color: #333333; margin-top: 10px;">© 2024 AAA Rental LLP. All rights reserved. · Noida Sector 62, Uttar Pradesh, India</div></td></tr>
            </table>
          </td>
        </tr>
            ...
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" style="background-color: #f6f6f6; border: 1px solid #e2e2e2; border-radius: 12px;">
              <tr>
                <td align="center" style="padding: 24px 20px; text-align: center;">
                  ...
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0" style="margin: 0 auto;">
                    <tr>
                      <td><a href="https://indian-rentals.vercel.app/review/{{ORDER_ID}}?rating=1" class="star-link" style="display: inline-block; padding: 0 8px; font-size: 30px; text-decoration: none; color: #ffcf46; line-height: 1;">★</a></td>
                      <td><a href="https://indian-rentals.vercel.app/review/{{ORDER_ID}}?rating=2" class="star-link" style="display: inline-block; padding: 0 8px; font-size: 30px; text-decoration: none; color: #ffcf46; line-height: 1;">★</a></td>
                      <td><a href="https://indian-rentals.vercel.app/review/{{ORDER_ID}}?rating=3" class="star-link" style="display: inline-block; padding: 0 8px; font-size: 30px; text-decoration: none; color: #ffcf46; line-height: 1;">★</a></td>
                      <td><a href="https://indian-rentals.vercel.app/review/{{ORDER_ID}}?rating=4" class="star-link" style="display: inline-block; padding: 0 8px; font-size: 30px; text-decoration: none; color: #ffcf46; line-height: 1;">★</a></td>
                      <td><a href="https://indian-rentals.vercel.app/review/{{ORDER_ID}}?rating=5" class="star-link" style="display: inline-block; padding: 0 8px; font-size: 30px; text-decoration: none; color: #ffcf46; line-height: 1;">★</a></td>
                    </tr>
                  </table>
                </td>
              </tr>
            ...
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
              <tr>
                <td align="center" style="text-align: center;">
                  ...
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0" style="margin: 0 auto;"><tr><td align="center" bgcolor="#ffcf46" style="background-color: #ffcf46; border-radius: 8px;"><a href="https://indian-rentals.vercel.app/rentals/{{ORDER_ID}}" class="cta-button" style="display: inline-block; padding: 13px 36px; font-family: 'Mona Sans Variable', sans-serif; font-size: 15px; font-weight: 700; color: #000000; text-decoration: none; border-radius: 8px;">View My Rental →</a></td></tr></table>
                </td>
              </tr>
            </table>
          </td>
        ...
        <tr>
          <td bgcolor="#141414" style="background-color: #141414; border-radius: 0 0 12px 12px; padding: 28px 32px;" class="mobile-pad">
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
              ...
              <tr><td align="center" style="text-align: center; padding-top: 16px; padding-bottom: 16px;"><table role="presentation" border="0" cellpadding="0" cellspacing="0" style="margin: 0 auto;"><tr><td style="padding: 0 12px; border-right: 1px solid #333333;"><a href="mailto:support@indianrenters.com" style="font-family: 'Mona Sans Variable', sans-serif; font-size: 12px; color: #757575; text-decoration: none;">support@indianrenters.com</a></td><td style="padding: 0 12px;"><a href="tel:9870533392" style="font-family: 'Mona Sans Variable', sans-serif; font-size: 12px; color: #757575; text-decoration: none;">+91 98705 33392</a></td></tr></table><div style="margin-top: 6px; font-family: 'Mona Sans Variable', sans-serif; font-size: 11px; color: #545454;">Mon – Sat, 10:00 AM – 7:30 PM</div></td></tr>
              <tr><td align="center" style="text-align: center; padding-bottom: 16px;"><div style="font-family: 'Mona Sans Variable', sans-serif; font-size: 11px; color: #545454; line-height: 18px;">Delhi · Noida · Bangalore · Hyderabad · Mumbai · Pune · Chennai · Kolkata</div></td></tr>
              <tr><td align="center" style="text-align: center; padding-top: 16px; border-top: 1px solid #1f1f1f;"><div style="font-family: 'Mona Sans Variable', sans-serif; font-size: 11px; color: #545454; line-height: 18px; margin-bottom: 8px;">This email was sent because your order was delivered on IndianRenters.com.</div><div><a href="https://indian-rentals.vercel.app/privacy" style="font-family: 'Mona Sans Variable', sans-serif; font-size: 11px; color: #545454; text-decoration: underline;">Privacy Policy</a><span style="color: #333333; padding: 0 6px;">·</span><a href="https://indian-rentals.vercel.app/terms" style="font-family: 'Mona Sans Variable', sans-serif; font-size: 11px; color: #545454; text-decoration: underline;">Terms of Service</a><span style="color: #333333; padding: 0 6px;">·</span><a href="https://indian-rentals.vercel.app/unsubscribe" style="font-family: 'Mona Sans Variable', sans-serif; font-size: 11px; color: #545454; text-decoration: underline;">Unsubscribe</a></div><div style="font-family: 'Mona Sans Variable', sans-serif; font-size: 10px; color: #333333; margin-top: 10px;">© 2024 AAA Rental LLP. All rights reserved. · Noida Sector 62, Uttar Pradesh, India</div></td></tr>
            </table>
          </td>
        </tr>
                      ...
                      <td class="option-col" style="width: 50%; vertical-align: top; padding-left: 10px;" width="50%">
                        <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" style="background-color: #f6f6f6; border: 1px solid #e2e2e2; border-radius: 10px;">
                          <tr><td style="padding: 18px 16px; text-align: center;">
                            ...
                            <table role="presentation" border="0" cellpadding="0" cellspacing="0" style="margin: 0 auto;"><tr><td align="center" bgcolor="#141414" style="background-color: #141414; border-radius: 7px;"><a href="https://indian-rentals.vercel.app/centers" style="display: inline-block; padding: 9px 18px; font-family: 'Mona Sans Variable', sans-serif; font-size: 13px; font-weight: 700; color: #ffffff; text-decoration: none; border-radius: 7px; white-space: nowrap;">Find Center →</a></td></tr></table>
                          </td></tr>
                        </table>
                      </td>
                    </tr>
        ...
        <tr>
          <td bgcolor="#141414" style="background-color: #141414; border-radius: 0 0 12px 12px; padding: 28px 32px;" class="mobile-pad">
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
              ...
              <tr><td align="center" style="text-align: center; padding-top: 16px; padding-bottom: 16px;"><table role="presentation" border="0" cellpadding="0" cellspacing="0" style="margin: 0 auto;"><tr><td style="padding: 0 12px; border-right: 1px solid #333333;"><a href="mailto:support@indianrenters.com" style="font-family: 'Mona Sans Variable', sans-serif; font-size: 12px; color: #757575; text-decoration: none;">support@indianrenters.com</a></td><td style="padding: 0 12px;"><a href="tel:9870533392" style="font-family: 'Mona Sans Variable', sans-serif; font-size: 12px; color: #757575; text-decoration: none;">+91 98705 33392</a></td></tr></table><div style="margin-top: 6px; font-family: 'Mona Sans Variable', sans-serif; font-size: 11px; color: #545454;">Mon – Sat, 10:00 AM – 7:30 PM</div></td></tr>
              <tr><td align="center" style="text-align: center; padding-bottom: 16px;"><div style="font-family: 'Mona Sans Variable', sans-serif; font-size: 11px; color: #545454; line-height: 18px;">Delhi · Noida · Bangalore · Hyderabad · Mumbai · Pune · Chennai · Kolkata</div></td></tr>
              <tr><td align="center" style="text-align: center; padding-top: 16px; border-top: 1px solid #1f1f1f;"><div style="font-family: 'Mona Sans Variable', sans-serif; font-size: 11px; color: #545454; line-height: 18px; margin-bottom: 8px;">This reminder was sent because your rental is approaching its end date on IndianRenters.com.</div><div><a href="https://indian-rentals.vercel.app/privacy" style="font-family: 'Mona Sans Variable', sans-serif; font-size: 11px; color: #545454; text-decoration: underline;">Privacy Policy</a><span style="color: #333333; padding: 0 6px;">·</span><a href="https://indian-rentals.vercel.app/terms" style="font-family: 'Mona Sans Variable', sans-serif; font-size: 11px; color: #545454; text-decoration: underline;">Terms of Service</a><span style="color: #333333; padding: 0 6px;">·</span><a href="https://indian-rentals.vercel.app/unsubscribe" style="font-family: 'Mona Sans Variable', sans-serif; font-size: 11px; color: #545454; text-decoration: underline;">Unsubscribe</a></div><div style="font-family: 'Mona Sans Variable', sans-serif; font-size: 10px; color: #333333; margin-top: 10px;">© 2024 AAA Rental LLP. All rights reserved. · Noida Sector 62, Uttar Pradesh, India</div></td></tr>
            </table>
          </td>
        </tr>
        ...
        <tr>
          <td bgcolor="#141414" style="background-color: #141414; border-radius: 0 0 12px 12px; padding: 28px 32px;" class="mobile-pad">
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
              ...
              <tr><td align="center" style="text-align: center; padding-top: 16px; padding-bottom: 16px;"><table role="presentation" border="0" cellpadding="0" cellspacing="0" style="margin: 0 auto;"><tr><td style="padding: 0 12px; border-right: 1px solid #333333;"><a href="mailto:support@indianrenters.com" style="font-family: 'Mona Sans Variable', sans-serif; font-size: 12px; color: #757575; text-decoration: none;">support@indianrenters.com</a></td><td style="padding: 0 12px;"><a href="tel:9870533392" style="font-family: 'Mona Sans Variable', sans-serif; font-size: 12px; color: #757575; text-decoration: none;">+91 98705 33392</a></td></tr></table><div style="margin-top: 6px; font-family: 'Mona Sans Variable', sans-serif; font-size: 11px; color: #545454;">Mon – Sat, 10:00 AM – 7:30 PM</div></td></tr>
              <tr><td align="center" style="text-align: center; padding-bottom: 16px;"><div style="font-family: 'Mona Sans Variable', sans-serif; font-size: 11px; color: #545454; line-height: 18px;">Delhi · Noida · Bangalore · Hyderabad · Mumbai · Pune · Chennai · Kolkata</div></td></tr>
              <tr><td align="center" style="text-align: center; padding-top: 16px; border-top: 1px solid #1f1f1f;"><div style="font-family: 'Mona Sans Variable', sans-serif; font-size: 11px; color: #545454; line-height: 18px; margin-bottom: 8px;">This email was sent to confirm your rental return on IndianRenters.com.</div><div><a href="https://indian-rentals.vercel.app/privacy" style="font-family: 'Mona Sans Variable', sans-serif; font-size: 11px; color: #545454; text-decoration: underline;">Privacy Policy</a><span style="color: #333333; padding: 0 6px;">·</span><a href="https://indian-rentals.vercel.app/terms" style="font-family: 'Mona Sans Variable', sans-serif; font-size: 11px; color: #545454; text-decoration: underline;">Terms of Service</a><span style="color: #333333; padding: 0 6px;">·</span><a href="https://indian-rentals.vercel.app/unsubscribe" style="font-family: 'Mona Sans Variable', sans-serif; font-size: 11px; color: #545454; text-decoration: underline;">Unsubscribe</a></div><div style="font-family: 'Mona Sans Variable', sans-serif; font-size: 10px; color: #333333; margin-top: 10px;">© 2024 AAA Rental LLP. All rights reserved. · Noida Sector 62, Uttar Pradesh, India</div></td></tr>
            </table>
          </td>
        </tr>
      ...
      <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="600" style="max-width: 600px; width: 100%;">
        ...
        <tr>
          <td bgcolor="#ffffff" style="background-color: #ffffff; border-radius: 12px 12px 0 0; padding: 20px 32px; border-bottom: 3px solid #ffcf46;">
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
              <tr>
                <td align="left" style="vertical-align: middle;"><a href="https://indian-rentals.vercel.app" style="text-decoration: none; display: inline-block;"><img src="https://res.cloudinary.com/dgkckcdk8/image/upload/w_360,q_auto,f_png/v1780249866/logo_indianrenters_tmfo74.png" alt="IndianRenters.com" width="160" height="auto" style="display: block; width: 160px; max-width: 160px; height: auto; border: 0;" /></a></td>
                  ...
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" style="border: 1px dashed #e0e0e0; border-radius: 10px;">
                    <tr>
                      <td align="center" style="padding: 18px 24px;">
                        ...
                        <a href="https://indian-rentals.vercel.app/feedback/cancel?order={{ORDER_ID}}" style="font-family: 'Mona Sans Variable', sans-serif; font-size: 13px; font-weight: 600; color: #0075ff; text-decoration: underline;">Why did you cancel? Tell us here →</a>
                      </td>
                    </tr>
                  </table>
                </td>
        ...
        <tr>
          <td bgcolor="#1a1a1a" style="background-color: #1a1a1a; border-top: 1px solid #2a2a2a; border-radius: 0 0 12px 12px; padding: 0;">
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
              <tr>
                <td style="padding: 24px 32px 28px 32px;">
                  <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td align="center" style="padding-bottom: 20px;"><a href="https://indian-rentals.vercel.app" style="text-decoration: none;"><img src="https://res.cloudinary.com/dgkckcdk8/image/upload/w_280,q_auto,f_png/v1780249784/white_indianrenters_nnqhiu.png" alt="IndianRenters.com" width="140" height="auto" style="display: block; width: 140px; max-width: 140px; height: auto; border: 0;" /></a></td></tr></table>
                  <p style="margin: 0 0 14px 0; font-family: 'Mona Sans Variable', sans-serif; font-size: 11px; color: #545454; line-height: 18px; text-align: center;">Serving&nbsp;&nbsp;Delhi · Noida · Bangalore · Hyderabad · Mumbai · Pune · Chennai · Kolkata</p>
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-bottom: 14px;"><tr><td bgcolor="#2a2a2a" style="background-color: #2a2a2a; height: 1px; font-size: 0; line-height: 0;">&nbsp;</td></tr></table>
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-bottom: 16px;">
                    <tr>
        ...
        <tr>
          <td bgcolor="#ffffff" style="background-color: #ffffff; padding: 0;">
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
              <tr>
                <td align="center" style="padding: 4px 32px 36px 32px;">
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0"><tr><td bgcolor="#ffcf46" style="background-color: #ffcf46; border-radius: 8px;" align="center"><a href="https://indian-rentals.vercel.app/kyc/resubmit" style="display: inline-block; padding: 14px 40px; font-family: 'Mona Sans Variable', sans-serif; font-size: 15px; font-weight: 700; color: #000000; text-decoration: none; border-radius: 8px;">↻ Resubmit KYC Documents</a></td></tr></table>
                </td>
              </tr>
            </table>
          </td>

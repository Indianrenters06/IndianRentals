    ...
    <table role="presentation" class="email-container" cellspacing="0" cellpadding="0" border="0" width="600" style="max-width: 600px; width: 100%;">
      ...
      <tr>
        <td bgcolor="#141414" style="background-color: #141414; border-radius: 0 0 12px 12px; padding: 32px 32px 28px 32px;">
          <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
            <tr><td align="center" style="padding-bottom: 20px;"><a href="https://indianrenters.com" style="text-decoration: none;"><img src="https://res.cloudinary.com/dgkckcdk8/image/upload/w_280,q_auto,f_png/v1780249784/white_indianrenters_nnqhiu.png" alt="IndianRenters.com" width="140" height="auto" style="display: block; width: 140px; height: auto; border: 0;" /></a></td></tr>
        ...
        <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="600" style="max-width: 600px; width: 100%;">
          ...
          <tr>
            <td bgcolor="#141414" align="center" style="background-color: #141414; border-radius: 0 0 12px 12px; padding: 28px 40px;">
              <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr><td align="center" style="padding-bottom: 12px;"><a href="https://indianrenters.com" style="text-decoration: none;"><img src="https://res.cloudinary.com/dgkckcdk8/image/upload/w_280,q_auto,f_png/v1780249784/white_indianrenters_nnqhiu.png" alt="IndianRenters.com" width="140" height="auto" style="display: block; width: 140px; max-width: 140px; height: auto; border: 0;" /></a></td></tr>
            ...
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
              <tr>
                <td align="center" style="padding: 28px 32px;">
                  <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
                    <tr><td align="center" style="padding-bottom: 20px;"><a href="https://indianrenters.com" style="text-decoration: none;"><img src="https://res.cloudinary.com/dgkckcdk8/image/upload/w_280,q_auto,f_png/v1780249784/white_indianrenters_nnqhiu.png" alt="IndianRenters.com" width="140" height="auto" style="display: block; width: 140px; max-width: 140px; height: auto; border: 0;" /></a></td></tr>
                  </table>
      ...
      <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="600" class="email-wrapper" style="max-width: 600px; width: 100%;">
        ...
        <tr>
          <td bgcolor="#ffffff" style="background-color: #ffffff; border-radius: 12px 12px 0 0; border-bottom: 3px solid #ffcf46; padding: 20px 32px;" class="mobile-pad">
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
              <tr>
                <td valign="middle"><a href="https://indianrenters.com" style="text-decoration: none; display: inline-block;"><img src="https://res.cloudinary.com/dgkckcdk8/image/upload/w_360,q_auto,f_png/v1780249866/logo_indianrenters_tmfo74.png" alt="IndianRenters.com" width="160" height="auto" style="display: block; width: 160px; max-width: 160px; height: auto; border: 0;" /></a></td>
        ...
        <tr>
          <td bgcolor="#141414" style="background-color: #141414; border-radius: 0 0 12px 12px; padding: 28px 32px;" class="mobile-pad">
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
              <tr><td align="center" style="text-align: center; padding-bottom: 16px; border-bottom: 1px solid #1f1f1f;"><a href="https://indianrenters.com" style="text-decoration: none;"><img src="https://res.cloudinary.com/dgkckcdk8/image/upload/w_280,q_auto,f_png/v1780249784/white_indianrenters_nnqhiu.png" alt="IndianRenters.com" width="140" height="auto" style="display: block; width: 140px; max-width: 140px; height: auto; border: 0;" /></a></td></tr>
      ...
      <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="600" style="max-width: 600px; width: 100%;">
        ...
        <tr>
          <td bgcolor="#ffffff" style="background-color: #ffffff; border-radius: 12px 12px 0 0; padding: 20px 32px; border-bottom: 3px solid #ffcf46;">
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
              <tr>
                <td align="left" style="vertical-align: middle;"><a href="https://indianrenters.com" style="text-decoration: none; display: inline-block;"><img src="https://res.cloudinary.com/dgkckcdk8/image/upload/w_360,q_auto,f_png/v1780249866/logo_indianrenters_tmfo74.png" alt="IndianRenters.com" width="160" height="auto" style="display: block; width: 160px; max-width: 160px; height: auto; border: 0;" /></a></td>
        ...
        <tr>
          <td bgcolor="#1a1a1a" style="background-color: #1a1a1a; border-top: 1px solid #2a2a2a; border-radius: 0 0 12px 12px; padding: 0;">
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
              <tr>
                <td style="padding: 24px 32px 28px 32px;">
                  <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td align="center" style="padding-bottom: 20px;"><a href="https://indianrenters.com" style="text-decoration: none;"><img src="https://res.cloudinary.com/dgkckcdk8/image/upload/w_280,q_auto,f_png/v1780249784/white_indianrenters_nnqhiu.png" alt="IndianRenters.com" width="140" height="auto" style="display: block; width: 140px; max-width: 140px; height: auto; border: 0;" /></a></td></tr></table>
                  <p style="margin: 0 0 14px 0; font-family: 'Mona Sans Variable', sans-serif; font-size: 11px; color: #545454; line-height: 18px; text-align: center;">Serving&nbsp;&nbsp;Delhi · Noida · Bangalore · Hyderabad · Mumbai · Pune · Chennai · Kolkata</p>
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-bottom: 14px;"><tr><td bgcolor="#2a2a2a" style="background-color: #2a2a2a; height: 1px; font-size: 0; line-height: 0;">&nbsp;</td></tr></table>
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-bottom: 16px;">
                    <tr>

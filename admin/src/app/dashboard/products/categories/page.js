...
import { FiPlus, FiFolder, FiFolderPlus, FiImage, FiSettings, FiTrash2, FiEdit2 } from "react-icons/fi";
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.5 }}>
                    <h1 className="text-3xl font-bold tracking-tight text-slate-900 dark:text-slate-100 mb-1">
                        Category <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-500 to-teal-500">Management</span>
                    </h1>
                ...
                <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.5 }}>
                    <Button
                        color="primary"
                        variant="shadow"
                        className="shadow-emerald-500/30 font-medium bg-emerald-500"
                        startContent={<FiFolderPlus className="w-5 h-5" />}
                        onPress={onOpen}
                    >
                        Add New Category
                    </Button>
                                        ...
                                        <TableCell>
                                            <div className="flex items-center gap-4">
                                                ...
                                                <div className="flex flex-col">
                                                    <span className="text-sm font-semibold text-slate-900 dark:text-slate-200 group-hover:text-emerald-500 transition-colors">{cat.name}</span>
                        ...
                        <>
                            <ModalHeader className="flex flex-col gap-1 text-slate-900 dark:text-white">
                                <div className="flex items-center gap-2">
                                    <FiFolder className="text-emerald-500" /> Add Root Category
                                </div>
                            </ModalHeader>
                            <ModalBody>
                                <Input
                                ...
                                <Input
                                    ...
                                    variant="bordered"
                                    labelPlacement="outside"
                                    startContent={<FiImage className="text-slate-400" />}
                                    classNames={{ label: "text-slate-700 dark:text-slate-300 font-medium" }}
                                />
                            </ModalBody>
                            <ModalFooter>
                                ...
                                <Button color="primary" className="bg-emerald-500" onPress={() => handleCreateCategory(onClose)}>
                                    Create Category
                                </Button>
                            </ModalFooter>
                        </>

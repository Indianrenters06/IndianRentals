...
export default function ActiveCoupons() {
    ...
    const [sortDescriptor, setSortDescriptor] = useState({ column: "code", direction: "ascending" });
            ...
            <Card className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden">
                <CardBody className="p-0">
                    {loading ? (
                        ...
                        <Table aria-label="Coupons table" sortDescriptor={sortDescriptor} onSortChange={setSortDescriptor} classNames={{ wrapper: "p-0 rounded-none shadow-none bg-transparent", th: "bg-slate-50 dark:bg-slate-950/80 uppercase text-xs font-bold h-12 pt-0 px-6", td: "py-4 px-6 border-b border-slate-100 dark:border-slate-800/50" }}>
                            <TableHeader>
                                ...
                                <TableColumn key="expiryDate" allowsSorting>EXPIRES</TableColumn>
                                <TableColumn key="usageCount" allowsSorting>USES</TableColumn>
                                <TableColumn key="isActive" align="center">STATUS</TableColumn>
                                <TableColumn key="actions" align="center">ACTIONS</TableColumn>
                            </TableHeader>
                            <TableBody items={sortedItems} emptyContent="No coupons yet. Click 'Create Coupon' to add one.">
                                {(item) => (
